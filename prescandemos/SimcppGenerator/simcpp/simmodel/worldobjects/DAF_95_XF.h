...
public:
  explicit DAF_95_XF(){
    ...
    cameraUnit_DAF_95_XF_CameraSensor_1_R = std::make_shared<std::vector<uint8_t>>();
    cameraUnit_DAF_95_XF_CameraSensor_1_G = std::make_shared<std::vector<uint8_t>>();
    cameraUnit_DAF_95_XF_CameraSensor_1_B = std::make_shared<std::vector<uint8_t>>();

    //Construct Lms sensor properties
    lmsUnit_DAF_95_XF_LMSSensor_1_Lines = std::make_shared<std::vector<std::vector<PRESCAN_LMS_DATA>>>();
...
//DECONSTRUCT//
  ...
  void registerSimulationUnits(const prescan::api::experiment::Experiment& experiment, 
    ...
    cameraSensor_DAF_95_XF_CameraSensor_1 = experiment.getObjectByName<prescan::api::camera::CameraSensor>("CameraSensor_1");
    cameraUnit_DAF_95_XF_CameraSensor_1 = prescan::sim::registerUnit<prescan::sim::CameraSensorUnit>(simulation, cameraSensor_DAF_95_XF_CameraSensor_1);

    //register Lms sensor units
    lmsSensor_DAF_95_XF_LMSSensor_1 = experiment.getObjectByName<prescan::api::lms::LmsSensor>("LMSSensor_1");
    lmsUnit_DAF_95_XF_LMSSensor_1 = prescan::sim::registerUnit<prescan::sim::LmsSensorUnit>(simulation, lmsSensor_DAF_95_XF_LMSSensor_1, simulation->getSimulationPath());
...
//INITIALIZE//
  ...
  void step(prescan::sim::ISimulation* simulation, prescan::sim::ISimulationModel * simmodel) {
    ...
    prescan::sensorDemux::demux_cameraSimulinkU8(
      cameraUnit_DAF_95_XF_CameraSensor_1,
      //Demux:
      cameraUnit_DAF_95_XF_CameraSensor_1_R, // ->R (valid)
      cameraUnit_DAF_95_XF_CameraSensor_1_G, // ->G (valid)
      cameraUnit_DAF_95_XF_CameraSensor_1_B); // ->B (valid)

    //demux lms sensor outputs
    prescan::sensorDemux::demux_lms(
      lmsUnit_DAF_95_XF_LMSSensor_1,
      //Demux:
      lmsUnit_DAF_95_XF_LMSSensor_1_Lines); // ->Lines (valid)
...
public:
    ...
    prescan::api::camera::CameraSensor cameraSensor_DAF_95_XF_CameraSensor_1;
    prescan::sim::CameraSensorUnit* cameraUnit_DAF_95_XF_CameraSensor_1{nullptr};
    std::shared_ptr<std::vector<uint8_t>> cameraUnit_DAF_95_XF_CameraSensor_1_R;
    std::shared_ptr<std::vector<uint8_t>> cameraUnit_DAF_95_XF_CameraSensor_1_G;
    std::shared_ptr<std::vector<uint8_t>> cameraUnit_DAF_95_XF_CameraSensor_1_B;

    //Add Lms sensor properties
    prescan::api::lms::LmsSensor lmsSensor_DAF_95_XF_LMSSensor_1;
    prescan::sim::LmsSensorUnit* lmsUnit_DAF_95_XF_LMSSensor_1{nullptr};
    std::shared_ptr<std::vector<std::vector<PRESCAN_LMS_DATA>>> lmsUnit_DAF_95_XF_LMSSensor_1_Lines;
