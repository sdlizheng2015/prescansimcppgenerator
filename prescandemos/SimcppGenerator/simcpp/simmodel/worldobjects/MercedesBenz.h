...
public:
  explicit MercedesBenz(){
    ...
    pcsUnit_MercedesBenz_PointCloudSensor_1_X = std::make_shared<std::vector<float>>();
    pcsUnit_MercedesBenz_PointCloudSensor_1_Y = std::make_shared<std::vector<float>>();
    pcsUnit_MercedesBenz_PointCloudSensor_1_Z = std::make_shared<std::vector<float>>();
    pcsUnit_MercedesBenz_PointCloudSensor_1_ID = std::make_shared<std::vector<float>>();
    pcsUnit_MercedesBenz_PointCloudSensor_1_I = std::make_shared<std::vector<float>>();
...
//DECONSTRUCT//
  ...
  void registerSimulationUnits(const prescan::api::experiment::Experiment& experiment, 
    ...
    pcsSensor_MercedesBenz_PointCloudSensor_1 = experiment.getObjectByName<prescan::api::pcs::PcsSensor>("PointCloudSensor_1");
    pcsUnit_MercedesBenz_PointCloudSensor_1 = prescan::sim::registerUnit<prescan::sim::PcsSensorUnit>(simulation, pcsSensor_MercedesBenz_PointCloudSensor_1);
...
//INITIALIZE//
  ...
  void step(prescan::sim::ISimulation* simulation, prescan::sim::ISimulationModel * simmodel) {
    ...
    prescan::sensorDemux::demux_pcsPosition(
      pcsUnit_MercedesBenz_PointCloudSensor_1,
      pcsSensor_MercedesBenz_PointCloudSensor_1,
      1, // outputIntensity?, DON'T EDIT
      1, // outputObjectID?, DON'T EDIT
      //Demux:
      pcsUnit_MercedesBenz_PointCloudSensor_1_X, // ->X (valid)
      pcsUnit_MercedesBenz_PointCloudSensor_1_Y, // ->Y (valid)
      pcsUnit_MercedesBenz_PointCloudSensor_1_Z, // ->Z (valid)
      pcsUnit_MercedesBenz_PointCloudSensor_1_I, // ->I (valid)
      pcsUnit_MercedesBenz_PointCloudSensor_1_ID); // ->ID (valid)
...
public:
    ...
    prescan::api::pcs::PcsSensor pcsSensor_MercedesBenz_PointCloudSensor_1;
    prescan::sim::PcsSensorUnit* pcsUnit_MercedesBenz_PointCloudSensor_1{nullptr};
    std::shared_ptr<std::vector<float>> pcsUnit_MercedesBenz_PointCloudSensor_1_X;
    std::shared_ptr<std::vector<float>> pcsUnit_MercedesBenz_PointCloudSensor_1_Y;
    std::shared_ptr<std::vector<float>> pcsUnit_MercedesBenz_PointCloudSensor_1_Z;
    std::shared_ptr<std::vector<float>> pcsUnit_MercedesBenz_PointCloudSensor_1_ID;
    std::shared_ptr<std::vector<float>> pcsUnit_MercedesBenz_PointCloudSensor_1_I;
